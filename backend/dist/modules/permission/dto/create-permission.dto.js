...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'order:create', description: 'Mã quyền duy nhất' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Tạo mới đơn hàng', description: 'Tên quyền hạn' }),
    (0, class_validator_1.IsString)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.IS_STRING') }),
    (0, class_validator_1.IsNotEmpty)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.NOT_EMPTY') }),
    __metadata("design:type", String)
], CreatePermissionDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'order', description: 'Tên module chứa quyền' }),
    (0, class_validator_1.IsString)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.IS_STRING') }),
    (0, class_validator_1.IsNotEmpty)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.NOT_EMPTY') }),
    __metadata("design:type", String)
], CreatePermissionDto.prototype, "module", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Mô tả quyền hạn' }),
    (0, class_validator_1.IsString)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.IS_STRING') }),
