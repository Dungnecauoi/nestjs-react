...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'IT', description: 'Mã phòng ban / team' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Phòng Công Nghệ', description: 'Tên phòng ban' }),
    (0, class_validator_1.IsString)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.IS_STRING') }),
    (0, class_validator_1.IsNotEmpty)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.NOT_EMPTY') }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'ID phòng ban cấp cha (nếu có)' }),
    (0, class_validator_1.IsString)({ message: (0, nestjs_i18n_1.i18nValidationMessage)('validation.IS_STRING') }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
